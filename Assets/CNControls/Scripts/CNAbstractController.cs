...
public abstract class CNAbstractController : MonoBehaviour
{
    ...
    /// </summary>
    public event Action<Vector3> ControllerMovedEvent;
    /// <summary>
    ...
    /// </summary>
    public event Action FingerLiftedEvent;
    ...
    protected virtual void OnFingerTouched()
    {
        if (FingerTouchedEvent != null)
            FingerTouchedEvent();
		// TODO: NC customization because I couldn't get any inheritiance to work correctly. The inspector wouldnt show public properties even if I created another abstract
		// class implementation. Try and make this more conventional.
		touched = true;
    }
